...
/**
 * @file RenameCatalog.hpp
 * @brief Содержит объявление класса RenameCatalog
 */

/**
 * @class RenameCatalog
 * @brief Переименовывает раздел каталога
...
private:
    ...
    string oldname;/**< Строка старого имени каталога */
    string newname;/**< Строка нового имени каталога */
...
public:
    ...
    /**
    * @brief Конструктор объекта RenameCatalog
