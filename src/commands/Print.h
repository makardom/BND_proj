...
/**
 * @file Print.hpp
 * @brief Содержит объявление класса Print
 */

/**
 * @class Print
 * @brief Выводит библиотечные данные
 * @details Наследуется от класса BaseCommand и реализует методы checkAndAssemble(), run() и help().
 */
#ifndef BND_CONSOLE_PRINT_H
#define BND_CONSOLE_PRINT_H
...
public:
    ...
    /**
    * @brief Конструктор объекта Print
    * @param libraryData Ссылка на данные библиотеки
    */
    explicit Print(LibraryData &libraryData);
