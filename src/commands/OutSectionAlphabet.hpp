...
/**
 * @file OutSectionAlphabet.hpp
 * @brief Содержит объявление класса OutSectionAlphabet
 */

/**
 * @class OutSectionAlphabet
 * @brief Выводит записи каталога в алфавитном порядке
...
public:
    ...
    /**
    * @brief Конструктор объекта OutSectionAlphabet
