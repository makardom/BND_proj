...
/**
 * @file Reorganization.hpp
 * @brief Содержит объявление класса Reorganization
 */

/**
 * @class Reorganization
 * @brief Реарганизуей блоки данных, убирая пустые в конец
...
public:
    ...
    /**
    * @brief Конструктор объекта Reorganization
